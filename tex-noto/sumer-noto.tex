...
\index{zid {\fcm 𒍣}  ! true}
\index{lul {\fcm 𒈜}  ! false}
\index{hhulu {\fcm 𒅆𒌨}  ! bad}
\index{dugud {\fcm 𒂂}  ! heavy}
\index{du10 {\fcm 𒄭}  ! sweet}
\index{ku3 {\fcm 𒆬}  ! holly}
\index{sikil {\fcm 𒂖}  ! clean}
\index{silim {\fcm 𒁲}  ! healthy}
\index{sis {\fcm 𒋀}  ! bitter}
...
\section{Intransitive and Trasitive verbs}
...
\begin{tabular}[!h]{l l l l l l l}
  ...
  you entedered (pl.) & {\fcm 𒈨𒂗𒍢𒂗𒉌𒆭𒊑𒂗𒍢𒂗}\\
  & (me en ze2 en i3 ku4 re en ze2 en)\\
\end{tabular}
\index{ku4 (ku4) ! to enter}


\section{Two-participant hamtu}
In this conjugation, the 1st-singular person
...
Before the pronominal suffixes,
a suffix /-ed/ or /-d/ may be inserted
to give an idea of the future.
If a vowel follows,
